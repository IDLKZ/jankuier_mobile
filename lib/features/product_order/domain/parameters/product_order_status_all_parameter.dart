...
class ProductOrderStatusFilterParameter {
  final String? search;
  ...
  const ProductOrderStatusFilterParameter({
    this.search,
  ...
  ProductOrderStatusFilterParameter copyWith({
    String? search,
    String? orderBy,
    ...
    return ProductOrderStatusFilterParameter(

...
abstract class AuthRepository {
  ...
  Future<Either<Failure, bool>> updatePassword(UpdatePasswordParameter parameter);
  Future<Either<Failure, UserEntity>> updateProfile(UpdateProfileParameter parameter);
}
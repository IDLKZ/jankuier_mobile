...
@injectable
class GetSeasonByIdUseCase implements UseCase<KffLeagueSingleResponseEntity<KffLeagueSeasonEntity>, int> {
  final KffLeagueRepository repository;

  GetSeasonByIdUseCase(this.repository);

  @override
  Future<Either<Failure, KffLeagueSingleResponseEntity<KffLeagueSeasonEntity>>> call(int params) async {
    return await repository.getSeasonById(params);
  }
}
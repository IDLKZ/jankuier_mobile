...
class MatchCardWidget extends StatelessWidget {
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          match.stadiumObj?.title?.ru ?? 'Стадион не указан',
                          style: TextStyle(
                            fontSize: 11.sp,
                            color: AppColors.textSecondary,
                      ...
                      SizedBox(width: 8.w),
                      Text(
                        _formatMatchDate(match.datetimeIso),
                        style: TextStyle(
                          fontSize: 11.sp,
                          color: AppColors.textSecondary,
                          fontWeight: FontWeight.w500,
                ...
                if (!isFuture && (match.attendance != null || match.protocol != null)) ...[
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        if (match.attendance != null && match.protocol != null)
                          SizedBox(height: 8.h),
  ...
  String _formatMatchDate(String? dateTimeIso) {
    if (dateTimeIso == null || dateTimeIso.isEmpty) {

...
class _MatchesPageState extends State<MatchesPage> {
  ...
  List<String> get tabs => [
        AppLocalizations.of(context)!.activeMatch,
                ...
                children: [
                  Padding(
                    ...
                    child: MainTitleWidget(
                      title: AppLocalizations.of(context)!.yourTickets,
                      fontSize: 18,
                    ),
                  ),
                  TicketCard(
                  ...
                  Padding(
                    ...
                    child: MainTitleWidget(
                      title: AppLocalizations.of(context)!.availableTickets,
                      fontSize: 18,
                    ),
                  ),
                  TicketCard(
                    ...
                    team2Name: "Барселона",
                    team1LogoUrl:
                        "https://upload.wikimedia.org/wikipedia/ru/thumb/b/b2/%D0%A4%D0%9A_%D0%96%D0%B5%D1%82%D1%8B%D1%81%D1%83.png/250px-%D0%A4%D0%9A_%D0%96%D0%B5%D1%82%D1%8B%D1%81%D1%83.png",
                    team2LogoUrl:
                        "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/Barcelona_Sporting_Club_Logo.png/250px-Barcelona_Sporting_Club_Logo.png",
                    onBuyPressed: () {},
                    onMyTicketPressed: () {
                      showModalBottomSheet<void>(
                        useRootNavigator: true,
                ...
                FifaRankingList(
                  ...
                  entries: [
                    ...
                    FifaRankingEntry(
                        ...
                        country: "Италия",
                        logoUrl:
                            "https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/Flag_of_Italy.svg/250px-Flag_of_Italy.svg.png"),
                    FifaRankingEntry(
                        position: 3,
                        country: "Франция",
                        logoUrl:
                    ...
                    FifaRankingEntry(
                        ...
                        country: "Португалия",
                        logoUrl:
                            "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a8/Flag_of_Portugal_%28official%29.svg/250px-Flag_of_Portugal_%28official%29.svg.png"),
                    FifaRankingEntry(
                        position: 7,
                        country: "Нидерланды",
                        logoUrl:
                    ...
                    FifaRankingEntry(
                        ...
                        country: "Польша",
                        logoUrl:
                            "https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/Flag_of_Poland.svg/250px-Flag_of_Poland.svg.png"),
                  ],
                )
              ],
            ))
